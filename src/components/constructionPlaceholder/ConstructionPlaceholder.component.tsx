...
const ConstructionPlaceholder = (): JSX.Element => {
  return (
    <article className={injectClassNames('block', styles['placeholder'])}>
      <h2></h2>
      <p><FormattedMessage id="widgets.under-construction.description.why"
                           defaultMessage="We are building home for Zetter paintings"/></p>
      <p><FormattedMessage id="widgets.under-construction.description.dm"
