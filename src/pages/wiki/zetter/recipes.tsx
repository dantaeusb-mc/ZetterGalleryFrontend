        ...
        return (<article>
          ...
          <section id="crafting" ref={addSection(intl.formatMessage({
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid
                items={[AnyPlanksItem, AnyPlanksItem, null, AnyPlanksItem, AnyPlanksItem, null, StickItem, StickItem, null]}
                output={EaselItem} shapeless={false}/>
            </div>
            <p>
          ...
          <section id="paints" ref={addSection(intl.formatMessage({
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid
                items={[RedDyeItem, GreenDyeItem, BlueDyeItem, WhiteDyeItem, BlackDyeItem, null, null, null, null]}
                output={PaintsItem} shapeless={true}/>
              <CraftGrid
                items={[CyanDyeItem, MagentaDyeItem, YellowDyeItem, WhiteDyeItem, BlackDyeItem, null, null, null, null]}
                output={PaintsItem} shapeless={true}/>
            </div>
            <p>
          ...
          <section id="palette" ref={addSection(intl.formatMessage({
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid items={[null, null, null, PaintsItem, AnyPlanksItem, null, null, null, null]}
                         output={PaletteItem} shapeless={true}/>
              <CraftGrid items={[null, null, null, PaletteItem, PaintsItem, null, null, null, null]}
                         output={PaletteItem} shapeless={true}/>
            </div>
            <p>
          ...
          <section id="canvas" ref={addSection(intl.formatMessage({
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid items={[null, null, null, PaperItem, PaperItem, null, PaperItem, PaperItem, null]}
                         output={CanvasItem} shapeless={false}/>
            </div>
            <p>
          ...
          <section id="artist-table" ref={addSection(intl.formatMessage({
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid
                items={[PlanksSlabItem, PlanksSlabItem, PlanksSlabItem, AnyPlanksItem, PaintsItem, AnyPlanksItem, AnyPlanksItem, PaperItem, AnyPlanksItem]}
                output={ArtistTableItem} shapeless={false}/>
            </div>
            <p>
          ...
          <section id="frames" ref={addSection(intl.formatMessage({
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid
                items={[AnyPlanksItem, IronNuggetItem, AnyPlanksItem, StickItem, LeatherItem, StickItem, AnyPlanksItem, StickItem, AnyPlanksItem]}
                output={OakFrameItem} shapeless={false}/>
              <CraftGrid
                items={[DarkOakPlanksItem, GoldNuggetItem, DarkOakPlanksItem, StickItem, LeatherItem, StickItem, DarkOakPlanksItem, StickItem, DarkOakPlanksItem]}
                output={DarkOakPlatedFrameItem} shapeless={false}/>
            </div>
            <p>
            ...
            <h3>
              <FormattedMessage id={"wiki.zetter.recipes.framing.title"}
                                defaultMessage="Framing and Un-Framing Paintings"/>
            </h3>
            <div className={styles['recipes-grid']}>
              <CraftGrid items={[null, null, null, WarpedPlatedFrameItem, PaintingItem, null, null, null, null]}
                         output={WarpedPlatedFrameWithPaintingItem} shapeless={true}/>
              <CraftGrid items={[null, null, null, null, GoldPlatedFrameWithPaintingItem, null, null, null, null]}
                         output={GoldPlatedFrameItem} shapeless={true}/>
            </div>
            <p>
          ...
          <section id="special-frames" ref={addSection(intl.formatMessage({
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid
                items={[IronNuggetItem, GlassPaneItem, IronNuggetItem, GlassPaneItem, LeatherItem, GlassPaneItem, IronNuggetItem, GlassPaneItem, IronNuggetItem]}
                output={IronFrameItem} shapeless={false}/>
            </div>
            <p>
            ...
            <div className={styles['recipes-grid']}>
              <CraftGrid
                items={[EmeraldItem, GoldIngotItem, EmeraldItem, GoldIngotItem, LeatherItem, GoldIngotItem, EmeraldItem, GoldIngotItem, EmeraldItem]}
                output={GoldPlatedFrameItem} shapeless={false}/>
              <CraftGrid items={[null, null, null, null, GoldPlatedFrameItem, null, null, GoldIngotItem, null]}
                         output={GoldPlatedFrameItem} shapeless={false}/>
            </div>
            <p>
